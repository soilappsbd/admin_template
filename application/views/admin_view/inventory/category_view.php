						  ...
						  <div class="modal-dialog  modal-md" role="document">
							<div class="modal-content">
							  ...
							  <div class="modal-body" style="padding: 30px;">
								...
								<form action="<?php echo base_url();?>category" method="POST" autocomplete="off">
							 
								  	<div class="row">
										<label class="col-md-3 col-xs-3 col-sm-3 col-lg-3 col-3 text-right" style="padding: 10px;" for="category">Category Name</label>
										<div class="col-md-9 col-xs-9 col-sm-9 col-lg-9 col-9">
											<div class="form-group">
												<input type="text" name="category" class="form-control" id="comments_add" placeholder="Category Name">
											</div>
										</div>
									</div>
									
									<div class="row">
										<label class="col-md-3 col-xs-3 col-sm-3 col-lg-3 col-3 text-right" style="padding: 10px;" for="item">Item</label>
										<div class="col-md-9 col-xs-9 col-sm-9 col-lg-9 col-9">
											<div class="form-group">
